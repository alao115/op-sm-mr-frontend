                  ...
                  interventions.length > 0 ? interventions.map((intervention) => {
                    return (
                      <tr key={intervention.id}>
                        ...
                        <td>
                          <span>
                            <Switch key={intervention.id} defaultValue={intervention.status} onText="Résolue" offText="Non résolue" onChange={(e) =>  changeInterventionState(e.state.value, intervention)} />
                          </span>
                        </td>
                      </tr>
                    );
